import CustomerChangedAddressEvent from "../../customer/event/customer-changed-address";
import CustomerCreatedEvent from "../../customer/event/customer-created";
...
describe("Domain events tests", () => {
  ...
  it("should register an CustomerCreatedEvent handler", () => {
    const eventDispatcher = new EventDispatcher();
